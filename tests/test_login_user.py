...
class TestLoginUser:
    ...
    def test_login_page_success_login_user_redirect_main_page(self,browser,registration_user, open_login_form, test_data_login):
        ...
        password_imput.send_keys( test_data_login.password)
    ...
    def test_login_page_success_login_user_is_displayed_user_avatar(self, browser,registration_user, open_login_form, test_data_login):
    ...
    def test_login_page_login_user_is_displayed_user_name(self,browser,registration_user, open_login_form, test_data_login):
