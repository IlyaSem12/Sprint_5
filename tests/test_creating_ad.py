...
class TestCreatingAd:
    ...
    def test_main_page_сreating_ad_unauthorized_user_shows_auth_modal_for_unauthorized_user(self,browser):
        ...
        header = webdrivwer.until(expected_conditions.visibility_of_element_located(HEADER_LOGIN_AND_REGISTRATION))
    ...
    def test_crating_ad_page_success_сreating_ad_authorized_user_shows_ad_in_profile(self,browser, open_create_listing_page, generate_product_name, test_data_ad):
